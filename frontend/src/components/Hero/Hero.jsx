...
const Hero = () => {
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      {/* Keep existing hero header section unchanged */}
      <section className="grid items-center gap-10 md:grid-cols-2">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl dark:text-white">
            Organize Your Work, <span className="text-amber-600">Simplify</span>{" "}
            Your Life
          </h1>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <button className="rounded-2xl bg-amber-600 px-5 py-3 text-white shadow-sm transition hover:bg-amber-400">
        ...
        {/* Replace static table with interactive Kanban preview */}
      ...
      {/* Enhanced features section with role-based workflow */}
      <section className="mt-16">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Role-Based Control</h3>
            <p className="text-zinc-600 dark:text-zinc-300 mb-4">
              Admin, Product Owner, and Developer roles with specific permissions for task management and workflow control.
            </p>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 bg-red-500 rounded-full"></span>
                <span className="dark:text-zinc-300">Admin: Full system control</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 bg-blue-500 rounded-full"></span>
                <span className="dark:text-zinc-300">PO: Task & team management</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 bg-green-500 rounded-full"></span>
                <span className="dark:text-zinc-300">Dev: Assigned task updates</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Kanban Workflow</h3>
            <p className="text-zinc-600 dark:text-zinc-300 mb-4">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <p className="text-zinc-600 dark:text-zinc-300 mb-4">
              Built-in commenting system, task assignment, and priority tracking for seamless team coordination.
            </p>
